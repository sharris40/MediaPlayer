...
public class SuperPlaylistListViewFragment extends ListFragment {
    ...
    public void onActivityCreated(Bundle savedState) {
        ...
        setListAdapter(new ArrayAdapter<String>(getActivity(),R.layout.fragment_super_playlist_list_view, SuperPlaylistListActivity.mListArray));
